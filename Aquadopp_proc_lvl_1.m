...
%
lok_data = ~isnan(atmpresanomaly.atm_anomaly);
%
atmpresanomaly.dtime = atmpresanomaly.dtime(lok_data);
atmpresanomaly.atm_anomaly = atmpresanomaly.atm_anomaly(lok_data);
